...
static const int64_t DARKSEND_COLLATERAL = (.01*COIN); //30000
...
static const unsigned int DEFAULT_MAX_ORPHAN_BLOCKS = 500;
...
static const int64_t MAX_MONEY = 333333333 * COIN;
