...
unsigned int nStakeMaxAge = 24 * 10000 * 60 * 60;
...
const string strMessageMagic = "RenosCoin Signed Message:\n";
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "RenosCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "zondag 26 februari 2017 da20b20c-f348-4c63-86f8-9d6e7f93caf7";
        CTransaction txNew;
        txNew.nTime = 1488110286;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime = 1488110286;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce = 1363724 ;
		if(fTestNet)
        {
            block.nNonce = 1363724 ;
        }
		
		uint256 nhashMerkleRoot = uint256("0x8fce52366a8f9b85ea09bada98642761f66cba89267c6f2853986754d487a919");
